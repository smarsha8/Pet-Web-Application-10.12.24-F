...
{
    public class PuppiesProductPurchasesDbFContext : DbContext
    {
        public PuppiesProductPurchasesDbFContext (DbContextOptions<PuppiesProductPurchasesDbFContext> options)
            : base(options)
        {
        }
