...
namespace Pet_Web_Application_10._12._24_F.Controllers
{
    ...
    {
        private readonly PuppiesandProductPurchasesContext _context;

        public PuppiesController(PuppiesandProductPurchasesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,BreedName,PuppyPrice,ProductName")] Puppies puppies)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BreedName,PuppyPrice,ProductName")] Puppies puppies)
        {
            if (id != puppies.Id)
            {
                return NotFound();
